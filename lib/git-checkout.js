...
module.exports = GitCheckout = {
  ...
  pull: function(rebase) {
    return this.execCommandInProject(`git pull ${rebase ? "--rebase" : "--no-edit"} ${this.current}`);
  },
            ...
            this.rootComponent = ReactDOM.render(
              (
                <BranchList
                  ...
                  onBlur={() => {this.toggle(); console.log("blur");}}
                  onEscape={() => {this.toggle(); console.log("escape");}}/>
              ),
